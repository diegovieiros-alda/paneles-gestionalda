...
urlpatterns = [
    ...
    path('desayunos/ajustes/hoteles/', views.desayunos_ajustes_hoteles, name='desayunos_ajustes_hoteles'),
    path('desayunos/ajustes/hoteles/<int:hotel_id>/', views.desayunos_ajustes_hotel, name='desayunos_ajustes_hotel'),
