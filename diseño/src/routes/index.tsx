...
import { aggregate, hotels, monthlySeries, fmtEuro, fmtNum, fmtPct, TARGET_PENETRACION } from "@/lib/mock-data";
import { Target } from "lucide-react";

export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "¿Dónde actuar hoy? · Breakfast OS" },
      { name: "description", content: "Centro de decisiones diario para el servicio de desayunos: alertas, oportunidad, KPIs, ranking y evolución." },
      { property: "og:title", content: "Breakfast OS · Centro de decisiones" },
      { property: "og:description", content: "Panel operativo diario para Regional Managers, Operaciones y F&B." },
    ],
  }),
