  ...
  return (
    <section className="rounded-xl border border-border bg-surface p-5 shadow-soft">
      <header className="flex items-center justify-between mb-4">
        ...
        <Link to="/hoteles" className="text-xs text-primary hover:underline">Ver todos</Link>
      </header>
      {alerts.length === 0 ? (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-[11px] text-muted-foreground truncate">
                  {h.zona} · Penetración baja · <span className="text-foreground/70 num">{fmtPct(h.penetracion)} · objetivo 55%</span>
                </div>
              </div>
